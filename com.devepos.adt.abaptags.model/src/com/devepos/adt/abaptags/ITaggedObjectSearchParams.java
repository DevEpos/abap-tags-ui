 ...
 * </p>
 * <ul>
 * <li>{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#getTagIds
 * <em>Tag Ids</em>}</li>
 * <li>{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#getSearchScope
 * <em>Search Scope</em>}</li>
 * <li>{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#getQuery
 * <em>Query</em>}</li>
 * <li>{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#getMaxResults
 * <em>Max Results</em>}</li>
 * <li>{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#isMatchesAllTags
 * <em>Matches All Tags</em>}</li>
 * <li>{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#isWithTagInfo
 * <em>With Tag Info</em>}</li>
 * <li>{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#isWithFullTagInfo
 * <em>With Full Tag Info</em>}</li>
 * <li>{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#isQueryIsObjectUri
...
public interface ITaggedObjectSearchParams extends EObject {
	 ...
	 * {@link com.devepos.adt.abaptags.TagSearchScope}. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * '{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#getSearchScope
	...
	/**
	 * Sets the value of the
	 * '{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#getQuery
	...
	/**
	 * Sets the value of the
	 * '{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#getMaxResults
	...
	/**
	 * Sets the value of the
	 * '{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#isMatchesAllTags
	...
	/**
	 * Sets the value of the
	 * '{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#isWithTagInfo
	...
	/**
	 * Sets the value of the
	 * '{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#isWithFullTagInfo
	...
	/**
	 * Sets the value of the
	 * '{@link com.devepos.adt.abaptags.ITaggedObjectSearchParams#isQueryIsObjectUri
