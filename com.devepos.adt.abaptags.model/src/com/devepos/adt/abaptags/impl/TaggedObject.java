...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tagged Object</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.devepos.adt.abaptags.impl.TaggedObject#getObjectRef <em>Object Ref</em>}</li>
 *   <li>{@link com.devepos.adt.abaptags.impl.TaggedObject#getTags <em>Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaggedObject extends MinimalEObjectImpl.Container implements ITaggedObject {
	...
	public EList<IAdtObjectTag> getTags() {
		if (tags == null) {
			tags = new EObjectContainmentEList<IAdtObjectTag>(IAdtObjectTag.class, this, IAbapTagsPackage.TAGGED_OBJECT__TAGS);
		}
		return tags;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetObjectRef(IAdtObjRef newObjectRef, NotificationChain msgs) {
		IAdtObjRef oldObjectRef = objectRef;
		objectRef = newObjectRef;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IAbapTagsPackage.TAGGED_OBJECT__OBJECT_REF, oldObjectRef, newObjectRef);
	 ...
	 */
	@Override
	public void setObjectRef(IAdtObjRef newObjectRef) {
		if (newObjectRef != objectRef) {
			NotificationChain msgs = null;
			if (objectRef != null)
				msgs = ((InternalEObject)objectRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IAbapTagsPackage.TAGGED_OBJECT__OBJECT_REF, null, msgs);
			if (newObjectRef != null)
				msgs = ((InternalEObject)newObjectRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IAbapTagsPackage.TAGGED_OBJECT__OBJECT_REF, null, msgs);
			msgs = basicSetObjectRef(newObjectRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IAbapTagsPackage.TAGGED_OBJECT__OBJECT_REF, newObjectRef, newObjectRef));
	}
