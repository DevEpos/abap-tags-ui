...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Tag Query Type</b></em>',
...
public enum TagQueryType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TagQueryType[] VALUES_ARRAY =
		new TagQueryType[] {
			OBJECT_NAME,
			OBJECT_URI,
	 ...
	 * @generated
	 */
	public static final List<TagQueryType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static TagQueryType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TagQueryType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TagQueryType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TagQueryType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TagQueryType get(int value) {
		switch (value) {
			case OBJECT_NAME_VALUE: return OBJECT_NAME;
			case OBJECT_URI_VALUE: return OBJECT_URI;
			case OBJECT_NAME_TYPE_COMBO_VALUE: return OBJECT_NAME_TYPE_COMBO;
		}
		return null;
	}
	 ...
	 * @generated
	 */
	private TagQueryType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
