...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Tag Query Focus</b></em>',
...
public enum TagQueryFocus implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TagQueryFocus[] VALUES_ARRAY =
		new TagQueryFocus[] {
			OBJECT,
			PARENT_OBJECT,
		};
	 ...
	 * @generated
	 */
	public static final List<TagQueryFocus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static TagQueryFocus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TagQueryFocus result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TagQueryFocus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TagQueryFocus result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TagQueryFocus get(int value) {
		switch (value) {
			case OBJECT_VALUE: return OBJECT;
			case PARENT_OBJECT_VALUE: return PARENT_OBJECT;
		}
		return null;
	}
	 ...
	 * @generated
	 */
	private TagQueryFocus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
