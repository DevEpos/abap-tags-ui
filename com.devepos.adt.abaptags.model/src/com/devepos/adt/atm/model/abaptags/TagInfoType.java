...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Tag Info Type</b></em>',
...
public enum TagInfoType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TagInfoType[] VALUES_ARRAY =
		new TagInfoType[] {
			ALL,
			CHILDREN,
		};
	 ...
	 * @generated
	 */
	public static TagInfoType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TagInfoType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TagInfoType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TagInfoType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TagInfoType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TagInfoType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
