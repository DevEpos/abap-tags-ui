...
public class TagSelectionWizardPage extends AbstractBaseWizardPage {
    ...
    private void createTagsCheckBoxTree(final Composite parent) {
        ...
        final TreeViewerColumn nameColumn = new TreeViewerColumn(checkBoxViewer, SWT.FULL_SELECTION, SWT.NONE);
    ...
    private void updatePageStatus() {
        ...
        if (!newTags.isEmpty()) {
            tagStatus = new TagListValidator((List<ITag>) checkBoxViewer.getInput()).validate(true, false);
        }
